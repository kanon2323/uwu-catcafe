...
Config.Ped = {-737.3, -1033.92, 12.03, "Sr Manel",91.22,0x94562DD7,"a_m_m_farmer_01"} -- order: coords - name (label) - heading - hash - ped spawn name
Config.PedTargetLoc = vector3(-737.3, -1033.92, 12.03) -- Ped target location (must be the same as the ped)
